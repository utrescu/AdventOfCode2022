...
- At the start of the first cycle, the noop instruction begins execution. During the first cycle, `X` is **1**. After the first cycle, the noop - ruction finishes execution, doing nothing.
